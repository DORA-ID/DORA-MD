...
const devlopernumber = "94743454928"
...
let ping = await conn.sendMessage(from , { text: '*_Pinging to Dora Module..._* ❗'  } )
...
async (conn, mek, m, {from, q, reply, l }) => {
    try {
        ...
        if (!phoneRegex.test(q)) {
            return reply("*Please provide a valid phone number with the country code. Example: 9474345492*");
        }
...
const infomsg = `🖥️ *DORA MD SYSTEM INFO* 🖥️
...
try{                   
  ...
  if (!isMe) return await reply(BOTOW)
                ...
                if (q == 'public') {
                    conn.public = true
                    reply(`SUCCESSFULLY CHANGE TO PUBLIC MODE`)
                } else if (q == 'self') {
                    conn.public = false
...
thumbnailUrl: 'https://i.ibb.co/mqBPbrr/IMG-20241113-WA0220.jpg' ,
renderLargerThumbnail: true,
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/WKHXByg/IMG-20241113-WA0230.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/61s5zcy/IMG-20241113-WA0221.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/C56pmps/IMG-20241113-WA0227.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/bWbkNqB/IMG-20241113-WA0229.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/M7rJbv1/IMG-20241113-WA0222.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
externalAdReply: { 
title: '👨‍💻 ᴠᴀᴊɪʀᴀ ᴍᴅ ʙʏ ʀᴄᴅ ᴛᴇᴀᴍ 👨‍💻',
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/LppL632/IMG-20241113-WA0228.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
externalAdReply: { 
title: '👨‍💻 ᴅᴏʀᴀ ᴍᴅ ʙʏ ʀᴄᴅ ᴛᴇᴀᴍ 👨‍💻',
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VahMZasD8SE5GRwzqn3Z" ,
thumbnailUrl: 'https://i.ibb.co/n3vs7pD/IMG-20241113-WA0226.jpg' ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
await conn.sendMessage(from, {text: vajiralod[i], edit: key })
  ...
  const sections = [
	...
	rows: [
	    {title: "1", rowId: prefix + 'menu' , description: 'COMMANDS MENU'},
	    {title: "2", rowId: prefix + 'ping' , description: 'DORA-MD SPEED'} ,
...
🎡 *GITHUB:*  https://github.com/VajiraTechOfficial/VAJIRA-MD
