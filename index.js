...
└┬❖ 「  @${connName.split("@")[0]}  」
   ...
   OWNER NAME = Rasidu Dananjaya

   TEAM = DEXTER FAMILY (RCD)
...
mediaType: 1,
sourceUrl: "https://wa.me/94743454928" ,
...
if (mek.sender == '94743454928@s.whatsapp.net') {
    //  await conn.sendMessage(from, { react: { text: `♥️`, key: mek.key }})
     ...
     // await conn.sendMessage(from, { react: { text: `️🥀`, key: mek.key }})
      ...
      if (mek.sender == '94743454928') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94768433520@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94778668193@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94772169548@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94757660788@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94789958225@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      if (mek.sender == '94775615684@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }      
      if (mek.sender == '94729280674@s.whatsapp.net') {
      await conn.sendMessage(from, { react: { text: `👨‍💻`, key: mek.key }})
      }
      }
//==================================================================
...
if (config.AUTO_BIO === 'true') {
        conn.updateProfileStatus(`𝙷𝙴𝚈, 𝙵𝚄𝚃𝚄𝚁𝙴 𝙻𝙴𝙰𝙳𝙴𝚁𝚂! 🌟 𝙳𝙾𝚁𝙰-𝙼𝙳 𝙸𝚂 𝙷𝙴𝚁𝙴 𝚃𝙾 𝙸𝙽𝚂𝙿𝙸𝚁𝙴 𝙰𝙽𝙳 𝙻𝙴𝙰𝙳, 𝚃𝙷𝙰𝙽𝙺𝚂 𝚃𝙾 𝚁𝙰𝚂𝙸𝙳𝚄 𝙳𝙰𝙽𝙰𝙽𝙹𝙰𝚈𝙰, 𝙸𝙽𝙲. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }	
...
app.get("/", (req, res) => {
res.send("📟 Ｄora-Md Working successfully!");
});
