...
const ownername = "_RASIDU DANANJAYA_";
const botname = "👨‍💻 ＤＯＲＡ - ＭＤ 👨‍💻"
const owner = "https://wa.me/94743454928";
...
cmd({
    ...
    try {
        let wm = `👨‍💻 ᴅᴏʀᴀ ᴍᴅ ʙʏ ʀᴄᴅ ᴛᴇᴀᴍ 👨‍💻`
        if (os.hostname().length == 12) hostname = 'replit'
        else if (os.hostname().length == 36) hostname = 'heroku'
        else if (os.hostname().length == 8) hostname = 'koyeb'
        else hostname = os.hostname()
        let monspace = '```'
            const MNG = `❖👨‍💻 ᴅᴏʀᴀ ᴍᴅ ʙʏ ʀᴄᴅ ᴛᴇᴀᴍ 👨‍💻❖
...
let info = `👨‍💻 𝗗𝗢𝗥𝗔 𝗧𝗧 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘 𝗦𝗘𝗔𝗥𝗖𝗛👨‍💻
...
let info = `👨‍💻 𝗗𝗢𝗥𝗔 𝗜𝗚 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘 𝗦𝗘𝗔𝗥𝗖𝗛👨‍💻
...
rows: srh
    ...
    const listMessage = {
caption: `🎬 DORA MD LYRICS 🎬`,
image : { url: config.LOGO },	    
footer: 'LYRICS SEARCH BY DORA MD',
